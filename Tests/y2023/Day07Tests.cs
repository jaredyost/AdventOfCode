...
namespace AdventOfCode.Tests.Y2023
{
    ...
    {
        [TestMethod]
        public async Task Y2023_D07_Part1_Example()
        {
            // Arrange
            Day07 solver = new();
            string[] TestInput =
        ...
        [TestMethod]
        public async Task Y2023_D07_Part2_Example()
        {
            // Arrange
            Day07 solver = new();
            string[] TestInput =
        ...
        [TestMethod]
        public async Task Y2023_D07_Part1_Real()
        {
            // Arrange
            Day07 solver = new();
        ...
        [TestMethod]
        public async Task Y2023_D07_Part2_Real()
        {
            // Arrange
            Day07 solver = new();
