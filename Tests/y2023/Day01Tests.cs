...
namespace AdventOfCode.Tests.Y2023
{
    ...
    {
        [TestMethod]
        public async Task Y2023_D01_Part1_Example()
        {
            // Arrange
            Day01 solver = new();
            string[] TestInput =
        ...
        [TestMethod]
        public async Task Y2023_D01_Part2_Example()
        {
            // Arrange
            Day01 solver = new();
            string[] TestInput =
        ...
        [TestMethod]
        public async Task Y2023_D01_Part1_Real()
        {
            // Arrange
            Day01 solver = new();
        ...
        [TestMethod]
        public async Task Y2023_D01_Part2_Real()
        {
            // Arrange
            Day01 solver = new();
